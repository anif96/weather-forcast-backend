...
public class TomorrowForcastResponse {
    ...
    public TomorrowForcastResponse() {
       super();
    }

    public TomorrowForcastResponse(String time, float temperature, float temperatureApparent, String location, String sunsetTime, float temp12Am, float temp2Pm, float temp4Pm, float temp6Pm, float temp8Pm) {
        this.time = time;
